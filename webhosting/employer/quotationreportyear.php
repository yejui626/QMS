...
if($filter){
    $sql = "SELECT * FROM tb_quotation 
        ...
        WHERE q_statusID = '$filter' AND YEAR(q_date) = '$fyear'
...
$sql1 = "SELECT COUNT(*) FROM tb_quotation WHERE q_statusID = '3' AND YEAR(q_date) = '$fyear'";
$result1 = mysqli_query($con, $sql1);
$row1 = mysqli_fetch_array($result1);

$sql2 = "SELECT COUNT(*) FROM tb_quotation WHERE q_statusID = '2' AND YEAR(q_date) = '$fyear'";
$result2 = mysqli_query($con, $sql2);
$row2 = mysqli_fetch_array($result2);

$sql3 = "SELECT COUNT(*) FROM tb_quotation WHERE q_statusID = '1' AND YEAR(q_date) = '$fyear'";
$result3 = mysqli_query($con, $sql3);
$row3 = mysqli_fetch_array($result3);

$sql4 = "SELECT COUNT(*) FROM tb_quotation WHERE q_statusID = '5' AND YEAR(q_date) = '$fyear'";
	...
	<div class="row">
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <a href="quotationreportyear.php?filter=3&year=<?php echo $fyear;?>">
            ...
            <div class="col-lg-3 col-md-12">
            <a href="quotationreportyear.php?filter=2&year=<?php echo $fyear;?>">
            ...
            <div class="col-lg-3 col-md-12">
            <a href="quotationreportyear.php?filter=1&year=<?php echo $fyear;?>">
            ...
            <div class="col-lg-3 col-md-12">
            <a href="quotationreportyear.php?filter=5&year=<?php echo $fyear;?>">
                        ...
                        <tbody>
                            <?php
                                ...
                                while ($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<tr>";
                                    echo "<td>No Quotation in this year...</td>";
                                    echo "</tr>";
                                }
                            ?>    
...
echo '<div style="display:flex; justify-content: right;">
    <a id="printbtn" type="button" class="btn btn-primary btn-lg" onClick="printpage('.$fyear.', '.$filter.');" style="width:200px; margin-left:20px; margin-bottom:10px;">Print</a>';
...
function exportReportToExcel() {
    ...
    function printpage(fy, f) {
        ...
        mywindow.document.write('<h3 style="display:block;">POWEREC '+ filter + ' Quotation Report Year ' + fy +'</h3>');

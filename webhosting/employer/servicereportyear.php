...
if($filter){
    $sql = "SELECT * FROM tb_service 
        ...
        WHERE s_statusID = '$filter' AND YEAR(s_requestDate) = '$fyear'
    ...
    $sql = "SELECT * FROM tb_service 
        ...
        LEFT JOIN tb_status ON tb_service.s_statusID = tb_status.st_statusID
        LEFT JOIN tb_type ON tb_service.s_typeID = tb_type.t_typeID
        WHERE YEAR(s_requestDate) = '$fyear'
        ORDER BY s_requestDate DESC" ;
}
...
$sql1 = "SELECT COUNT(*) FROM tb_service WHERE s_statusID = '3' AND YEAR(s_requestDate) = '$fyear'";
$result1 = mysqli_query($con, $sql1);
$row1 = mysqli_fetch_array($result1);

$sql2 = "SELECT COUNT(*) FROM tb_service WHERE s_statusID = '2' AND YEAR(s_requestDate) = '$fyear'";
$result2 = mysqli_query($con, $sql2);
$row2 = mysqli_fetch_array($result2);

$sql3 = "SELECT COUNT(*) FROM tb_service WHERE s_statusID = '1' AND YEAR(s_requestDate) = '$fyear'";
$result3 = mysqli_query($con, $sql3);
$row3 = mysqli_fetch_array($result3);

$sql4 = "SELECT COUNT(*) FROM tb_service WHERE s_statusID = '5' AND YEAR(s_requestDate) = '$fyear'";
$result4 = mysqli_query($con, $sql4);
$row4 = mysqli_fetch_array($result4);

$sql5 = "SELECT COUNT(*) FROM tb_service WHERE s_statusID = '4' AND YEAR(s_requestDate) = '$fyear'";
	...
	<div class="row">
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col">
            <a href="servicereportyear.php?filter=3&year=<?php echo $fyear;?>">
            ...
            <div class="col">
            <a href="servicereportyear.php?filter=2&year=<?php echo $fyear;?>">
            ...
            <div class="col">
            <a href="servicereportyear.php?filter=1&year=<?php echo $fyear;?>">
            ...
            <div class="col">
            <a href="servicereportyear.php?filter=5&year=<?php echo $fyear;?>">
...
<div class="row">
    ...
    <a id="printbtn" type="button" class="btn btn-primary btn-lg" onClick="printpage('.$fyear.', '.$filter.');" style="width:200px; margin-bottom:10px;">Print</a>
</div>';
                        ...
                        <tbody>
                            <?php
                                ...
                                while ($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<tr>";
                                    echo "<td>No service in this year...</td>";
                                    echo "</tr>";
                                }
                            ?>    
...
<?php
    ...
    <a id="printbtn" type="button" class="btn btn-primary btn-lg" onClick="printpage('.$fyear.', '.$filter.');" style="width:200px; margin-left:15px;margin-bottom:10px;">Print</a>
';
...
<script>
    ...
    function printpage(fy, f) {
        ...
        mywindow.document.write('<h3 style="display:block;">POWEREC '+ filter + ' service Report Year ' + fy +'</h3>');

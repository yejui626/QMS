...
$d = date("d M Y",strtotime($cname["q_date"]));
?>
    ...
    <!-- ============================================================== -->
        ...
        <div class="page-wrapper" >
            <div class="container-fluid" style="display: flex; justify-content: center;">                
                    <!--<div class=" print white-box" style="position:relative; width:50%;"> -->
                           
                        <div class=" print white-box" style="position:relative; width:700px;">
                            ...
                            <div class="row">                              
                                <div class="col-8">                                                                      
                                    ...
                                    <p>
                                        ...
                                        echo'<br>';
                                        echo'<label style="padding-left: 52px;">'.$caddress["a_state"].' </label>';
                        ...
                        <div class = "row" style="position:absolute; bottom:5px; justify-content: center;">

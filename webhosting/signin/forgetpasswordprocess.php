...
if (mysqli_num_rows($result) == 1){
    ...
    $link = "<a href='www.metautm.tech/reset-password.php?key=".$emailId."&token=".$token."'>www.metautm.tech/reset-password.php?key=".$emailId."&token=".$token."</a>";

    $slink = "<a href='www.metautm.tech/reset-password.php?key=".$emailId."&token=".$token."'> Reset Password Link </a>";    

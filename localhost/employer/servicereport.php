...
$sql1 = "SELECT COUNT(*) FROM tb_service WHERE s_statusID = '3'";
$result1 = mysqli_query($con, $sql1);
$row1 = mysqli_fetch_array($result1);

$sql2 = "SELECT COUNT(*) FROM tb_service WHERE s_statusID = '2'";
$result2 = mysqli_query($con, $sql2);
$row2 = mysqli_fetch_array($result2);

$sql3 = "SELECT COUNT(*) FROM tb_service WHERE s_statusID = '1'";
$result3 = mysqli_query($con, $sql3);
$row3 = mysqli_fetch_array($result3);

$sql4 = "SELECT COUNT(*) FROM tb_service WHERE s_statusID = '5'";
$result4 = mysqli_query($con, $sql4);
$row4 = mysqli_fetch_array($result4);

$sql5 = "SELECT COUNT(*) FROM tb_service WHERE s_statusID = '4'";
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" >
                ...
                <?php 
                        ...
                        while ($cyear != ($pyear-1)){
                            echo '<option value="servicereportyear.php?year='.$cyear.'">'.$cyear.'</option>';
                            $cyear--;
                        }
	...
	<div class="row">
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col">
            <a href="servicereport.php?filter=3">
            ...
            <div class="col">
            <a href="servicereport.php?filter=2">
            ...
            <div class="col">
            <a href="servicereport.php?filter=1">
            ...
            <div class="col">
            <a href="servicereport.php?filter=5">
            ...
            <div class="col">
            <a href="servicereport.php?filter=4">
...
<script>
    ...
    function printpage(cy, py, f) {
        ...
        mywindow.document.write('<h3 style="display:block;">POWEREC '+ filter + ' Service Report Year ' + py + ' - ' + cy +'</h3>');

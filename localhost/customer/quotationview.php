            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                        <h4 class="page-title"> 
                            ...
                            /
                            <a href="servicedetails.php?id=<?php echo $cname['q_serviceID'] ?>" style="color:black;">Service Details</a>
                            /
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="POST" action="quotationmodifyprocess.php">
                            ...
                            <p>
                                ...
                                if ($status == '1'){
                                    echo"<a class='qaccept' type='button' title='Accept Quotation' data-bs-toggle='modal' data-bs-target='#qaccept' style='padding-left:20px;'> 
                                        <i class='fas fa-check-square fa-lg' aria-hidden='true'></i>
                                        </a> &nbsp
                                        <a class='qreject' type='button' title='Reject Quotation' data-bs-toggle='modal' data-bs-target='#qreject'> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <?php
                        if ($status == '1'){
                            echo "<a class='btn btn-success btn-lg' type='button' title='Accept Quotation' data-bs-toggle='modal' data-bs-target='#qaccept' style='padding-left:20px;'> 
                            Accept
                        </a> &nbsp

                        <a class='btn btn-danger btn-lg' type='button' title='Reject Quotation' data-bs-toggle='modal' data-bs-target='#qreject'> 
                            Reject
                        </a>";
                        } 
                        ?>
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              ...
              <div class="modal-footer">
                    <button type="button" class="btn btn-warning btn-lg" data-bs-dismiss="modal" onClick="reset();">
                        Close
                    </button>
                    <input type="submit" class="btn btn-danger btn-lg" value="Reject" required/>
              </div> 
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              ...
              <div class="modal-body text-center">
                    ...
                    <a type="button" class="btn btn-warning btn-lg" data-bs-dismiss="modal" style="margin-right: 10px; width: 85px;">
                        No
                    </a> 

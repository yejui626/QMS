...
<div class="pt-0 card-body white-box row justify-content-center">
...
<div class="table-responsive">
    ...
    <?php if($row['s_statusID']!='1' && $row['s_statusID']!='2')
{
echo"
                <!-- ============================================================== -->
                <!-- Start Page Content -->
                ...
                <div class='row'>
                    <div class='col-md-12'>
                            ...
                            <div class='d-md-flex mb-3'>
                                <h3><strong>Service Quotation</strong></h3>
                            </div>

                        <div class='card-body white-box row justify-content-center'>
                            <div class='table-responsive'>
                                <table class='table table-hover text-center' id = 'qtable'>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>";
                                            ...
                                            $sql1 = "SELECT * FROM tb_quotation
                                                    ...
                                                    ORDER BY q_statusID DESC, q_date;  
                                                    ";
